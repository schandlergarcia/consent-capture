...
export default class ConCapDisplayTypePurpose extends NavigationMixin (LightningElement) {
    ...
    get iconState(){
        ...
        return this.item.concap__ConsentValid__c === true ? 'utility:check' : 'utility:close';
    ...
    get iconStateTitle(){
        ...
        return this.item.concap__ConsentValid__c === true ? 'Valid' : 'Unsubscribed/Expired';
    ...
    get activeStyle(){
        ...
        return this.item.concap__ConsentValid__c === true ? '' : 'background-color:#f4f6f9;border-bottom: 2px solid red';
