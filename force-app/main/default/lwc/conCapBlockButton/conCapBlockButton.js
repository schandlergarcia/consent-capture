...
export default class ConCapBlockButton extends LightningElement {
    ...
    get selectedStyle(){
        ...
        let selectedStyle = 'border: 1px solid #1589ee; box-shadow: inset 0 0 0 1px #1589ee; min-height:' + this.minHeight + '; min-width:' + this.minWidth + ';';
        let notSelectedStyle = 'min-height:' + this.minHeight + '; min-width:' + this.minWidth + ';';

        return this.selectedItem === this.item.Name ?  selectedStyle : notSelectedStyle;
